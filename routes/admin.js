...
//Rota da pagina de adição de categoria 

    router.get('/categorias/add',eAdmin,(req,res)=>{
        res.render("admin/addcategorias")
    })

// Rota da pagina de edição de categoria
...
// Validação e criação de categoria
...
// Rota da pagina de adição de postagem
...
// Rota da pagina edição de postagens
    ...
    router.get("/postagens/edit/:id",eAdmin,(req,res)=>{
        ...
        Postagem.findOne({_id: req.params.id}).then((postagem)=>{
            ...
            Categoria.find().lean().then((categorias)=>{
                res.render("admin/editpostagens",{categorias:categorias,postagem:postagem.toJSON()})
